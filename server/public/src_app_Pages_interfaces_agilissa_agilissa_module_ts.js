                            ...
                            if (time >= from && time <= to) {
                                ...
                                if (dat.area == this.areaSelect) {
                                    if (this.infoArea) {
                                        ...
                                        console.log(this.infoArea, 'info');
