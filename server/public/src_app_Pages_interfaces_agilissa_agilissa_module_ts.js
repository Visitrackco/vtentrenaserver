                ...
                if (turnos.length > 0) {
                    if (turnos[0].Values.length > 0) {
                        ...
                        if ((lunesDesde && lunesHasta) || (martesDesde && martesHasta) || (miercolesDesde && miercolesHasta) || (juevesDesde && juevesHasta) || (viernesDesde && viernesHasta) || (sabadoDesde && sabadoHasta)) {
                            ...
                            this.calendarRef.nativeElement.getApi().setOption('slotDuration', '00:15:00');
                            console.log('Hola2');
                            this.eventsFormat();
                        }
                        else {
...
module.exports = ".separador {\n  margin: 20px 0;\n  border-bottom: 1px solid rgba(0, 0, 0, 0.3);\n}\n\n.loading {\n  display: flex;\n  flex-direction: column;\n  justify-content: center;\n  align-items: center;\n  font-size: 22px;\n  text-align: center;\n  font-weight: bold;\n  margin: 20px 0;\n  padding: 10px;\n}\n\n.infor {\n  padding: 10px;\n  margin-bottom: 10px;\n  background: #FBF6EC;\n}\n\n.fijo {\n  width: 25%;\n  position: fixed;\n  height: calc(100vh - 70px);\n  box-shadow: 0px 0px 50px 30px rgba(0, 0, 0, 0.1);\n  padding: 10px;\n  background-color: #fff;\n  top: 70px;\n  left: 0;\n  z-index: 100;\n  overflow-y: scroll;\n}\n\n.flex {\n  display: flex;\n  justify-content: space-between;\n  align-items: center;\n  font-size: 22px;\n}\n\n.flex ion-icon {\n  font-size: 28px;\n}\n\n.myEvent {\n  width: 100%;\n  padding: 10px;\n  font-size: 16px;\n  margin-bottom: 10px;\n  color: #000 !important;\n  border: 5px dotted #e1e1e1;\n}\n\n.bola {\n  width: 20px;\n  height: 20px;\n  border-radius: 100%;\n  margin-right: 10px;\n}\n\n.rosa {\n  background-color: #E85B6A;\n}\n\n.verde {\n  background-color: #7CE675;\n}\n\n.azul {\n  background-color: #4CA1EC;\n}\n\n.titulo {\n  background-color: #e1e1e1;\n  text-align: center;\n  font-weight: bold;\n}\n\n.center {\n  text-align: center;\n}\n/*# sourceMappingURL=data:application/json;base64, */";
